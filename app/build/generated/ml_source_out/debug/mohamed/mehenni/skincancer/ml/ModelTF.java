package mohamed.mehenni.skincancer.ml;
...
public final class ModelTF {
  @NonNull
  private final Model model;

  private ModelTF(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "modelTF.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static ModelTF newInstance(@NonNull Context context) throws IOException {
    return new ModelTF(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static ModelTF newInstance(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    return new ModelTF(context, options);
  }
